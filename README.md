...
- **Editing tools** — consistent multicursor navigation and deletion,
  Unicode-aware word and display-column navigation, code folding, find and
  replace, undo/redo, automatic indentation, and file watching
