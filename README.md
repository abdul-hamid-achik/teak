...
- **Editing tools** — consistent multicursor navigation, deletion, paired
  delimiters, and multi-selection clipboard operations; Unicode-aware word and
  display-column navigation; code folding, find and replace, undo/redo,
  automatic indentation, and file watching
